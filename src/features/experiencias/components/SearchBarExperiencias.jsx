      ...
      <div className="bg-white p-1 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex flex-col md:flex-row items-stretch border border-gray-100 overflow-hidden">
          ...
          <div className="flex items-center gap-3 w-full text-left">
            ...
            <div className="flex flex-col w-full">
              ...
              >
                ...
                <option value="Praia">{t('praia')}</option>
                <option value="Assomada">{t('assomada')}</option>
                <option value="São Domingos">{t('sao_domingos')}</option>
                <option value="Santa Cruz">{t('santa_cruz')}</option>
                <option value="São Salvador do Mundoa">{t('sao_salvador_mundoa')}</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div className="flex-[2] flex items-center px-6 py-4 border-b md:border-b-0 border-gray-100 hover:bg-gray-50 transition-colors">
          <div className="flex items-center gap-3 w-full text-left">
            ...
            <div className="flex flex-col w-full">
              <label className="text-[9px] uppercase font-black text-gray-400 tracking-[0.2em]">{t('levantamento_participacao')}</label>
              <DatePicker
                selected={startDate}
                onChange={onChange}
                startDate={startDate}
